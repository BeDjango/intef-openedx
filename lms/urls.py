...
urlpatterns = (
    ...
    # email for all users
    url(r'^emails_all_users$', 'emails_all_users.views.emails_all_users', name="emails_all_users"),
    url(r'^running_emails_for_all_users_tasks/$', 'emails_all_users.api.list_emails_for_all_users_tasks', name="list_emails_for_all_users_tasks"),
