...
ENABLE_CUSTOM_WELCOME_MESSAGE = True
...
FEATURES = {
    ...
    'ENABLE_EMAILS_FOR_ALL_USERS': True,
...
MIDDLEWARE_CLASSES = (
    ...
    'student.middleware.LastCourseAccessMiddleware',
...
# A human name for BULK_EMAIL_DEFAULT_FROM_EMAIL
BULK_ALL_USERS_EMAIL_FROM_NAME = 'Aprende INTEF'
