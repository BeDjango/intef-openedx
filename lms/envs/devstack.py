...
SITE_NAME = 'openedx.emergya.es:8000'
PLATFORM_TWITTER_ACCOUNT = '@educalab'
PLATFORM_FACEBOOK_ACCOUNT = 'http://www.facebook.com/educalab'
...
COURSE_DISCOVERY_FILTERS = ["org", "language", "effort"]
