    ...
    define([
        ...
        return function (fieldsData, authData, userAccountsApiUrl, userPreferencesApiUrl, accountUserId, platformName) {
            ...
            var sectionsData = [
                    ...
                    fields: [
                        ...
                        },
                        {
                            view: new FieldViews.DropdownFieldView({
                                model: userAccountModel,
                                required: true,
                                title: gettext('Autonomous community'),
                                valueAttribute: 'comuni',
                                options: fieldsData['comuni']['options'],
                                persistChanges: true
                            }) 
                        },
                        {
                            view: new FieldViews.DropdownFieldView({
                                model: userAccountModel,
                                required: true,
                                title: gettext('Are you an educator?'),
                                valueAttribute: 'esdoce',
                                options: fieldsData['esdoce']['options'],
                                persistChanges: true
                            })
                        }
                    ]
                ...
                {
                    title: gettext('Educational Information(optional)'),
                    fields: [
                        {
                            view: new FieldViews.TextFieldView({
                                model: userAccountModel,
                                title: gettext('Educational institution'),
                                valueAttribute: 'camp1',
                                persistChanges: true
                            })
                        },
                        {
                            view: new FieldViews.DropdownFieldView({
                                model: userAccountModel,
                                title: gettext('Type of institution'),
                                valueAttribute: 'camp2',
                                options: fieldsData['camp2']['options'],
                                persistChanges: true
                            })
                        },
                        {
                            view: new FieldViews.TextFieldView({
                                model: userAccountModel,
                                title: gettext('Instructing staff'),
                                valueAttribute: 'camp3',
                                persistChanges: true
                            })
                        },
                        {
                            view: new FieldViews.TextFieldView({
                                model: userAccountModel,
                                title: gettext('Specialization'),
                                valueAttribute: 'camp4',
                                persistChanges: true
                            })
                        },
                        {
