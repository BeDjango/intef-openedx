...
SEND_TO_STAFF = 'staff'
SEND_TO_ALL = 'all'
SEND_TO_CUSTOM = 'custom'

TO_OPTIONS = [SEND_TO_MYSELF, SEND_TO_STAFF, SEND_TO_ALL, SEND_TO_CUSTOM]
...
class EmailAllUsers(Email):
    """
    Stores information for an email for all users
    """
...
class CourseEmail(Email):
    ...
    #
    # * Custom: Sends an email to some users specified as a list of emails.
    #
    TO_OPTION_CHOICES = (
        (SEND_TO_MYSELF, 'Myself'),
    ...
    template_name = models.CharField(null=True, max_length=255)
    from_addr = models.CharField(null=True, max_length=255)
    custom_to_addr = models.TextField(null=True, blank=True)
    ...
    def create(
            ...
            text_message=None, template_name=None, from_addr=None, custom_to_addr=None):
        """
...
class CourseEmailTemplate(models.Model):
    ...
    MICROSITE_TARGET_CHOICES = (('mooc', 'Mooc'),
                                ('nooc', 'Nooc'),
                                ('spooc', 'Spooc'))
    CHOICES_TYPE_OF_EMAIL = (('course_email', _('Course Email')),
                             ('email_all_users', _('Email for all users')))
    ...
    microsite_target = models.CharField('Microsite Target', max_length=7, blank=False, choices=MICROSITE_TARGET_CHOICES, default='mooc')
    type_of_email = models.CharField(_('Type of email'), max_length=20, blank=False, choices=CHOICES_TYPE_OF_EMAIL, default='course_email') 
