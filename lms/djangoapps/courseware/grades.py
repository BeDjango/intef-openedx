...
def progress_summary(student, request, course, field_data_cache=None, scores_client=None, outer_atomic_value=False):
    """
    Returns progress summary for all chapters in the course.
    """
    progress = _progress_summary(student, request, course, field_data_cache, scores_client, outer_atomic_value)
    if progress:
...
def _progress_summary(student, request, course, field_data_cache=None, scores_client=None, outer_atomic_value=False):
    """
