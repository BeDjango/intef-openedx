...
urlpatterns = patterns(
    ...
    url(r'^get_csv_last_access$',
        'instructor.views.api.get_csv_last_access', name="get_csv_last_access"),
    ...
    url(r'^get_emails_from_csv$',
        'instructor.views.api.get_emails_from_csv', name="get_emails_from_csv"),
    ...
    # last access
    url(r'^last_access$',
        'instructor.views.last_access.get_all_last_access', name='last_access'),

    url(r'^last_access/(?P<offset>[0-9]+)$',
        'instructor.views.last_access.get_all_last_access', name='last_access'),
